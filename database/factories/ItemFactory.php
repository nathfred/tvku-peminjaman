...
class ItemFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        $additional_array = ['Laptop', 'MC', 'Flashdisk', 'USB Converter', 'Audio Converter'];
        ...
        $section = array_rand($items_array); //here yoy get random first of array(green or red or yellow)
