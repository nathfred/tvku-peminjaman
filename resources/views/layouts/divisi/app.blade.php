            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item has-sub {{ ($active === "loan") ? 'active' : '' }}">
                            ...
                            <ul class="submenu">
                                <li class="submenu-item">
                                    <a href="{{ route('divisi-show-loans') }}">List Peminjaman</a>
                                </li>
                                <li class="submenu-item">
                                    <a href="{{ route('divisi-create-loan') }}">Ajukan Peminjaman</a>
                                </li>
                            </ul>
                        </li>
